...
CDev\GoSocial:
    tables: {  }
    columns: { categories: { ogMeta: 'ogMeta LONGTEXT NOT NULL', useCustomOG: 'useCustomOG TINYINT(1) NOT NULL' }, products: { ogMeta: 'ogMeta LONGTEXT DEFAULT NULL', useCustomOG: 'useCustomOG TINYINT(1) NOT NULL' }, pages: { ogMeta: 'ogMeta LONGTEXT NOT NULL', showSocialButtons: 'showSocialButtons TINYINT(1) NOT NULL' } }
...
QSL\SpecialOffersBase:
    tables: [special_offer_type_translations, special_offer_translations, special_offers, special_offer_types, special_offer_images]
    columns: {  }
    dependencies: {  }
