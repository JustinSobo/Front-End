 ...
 class Checkout extends \XLite\Module\QSL\BraintreeVZ\Controller\Customer\Checkout implements \XLite\Base\IDecorator
{
    ...
    protected function doActionXpcIframe()
    {
        ...
        // Actually just does redirect to X-Payments page
        $transaction->getPaymentMethod()->getProcessor()->pay($transaction);
    }
    ...
    protected function doActionSaveCheckoutFormData()
    {
        ...
        $controller = new \XLite\Module\CDev\XPaymentsConnector\Controller\Customer\FakeCheckout();

        $result = $controller->imitateActionCheckout();
