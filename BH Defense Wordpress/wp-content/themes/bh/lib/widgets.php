...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    'name'          => __('About', 'roots'),
    'id'            => 'sidebar-about',
    'before_widget' => '<section class="page-nav widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<div class="title-fx">
        <span class="title-fx-back">Naviga<br>tion</span>
        <h3 class="title-fx-front blog-title text-left page-nav-title">',
    'after_title'   => '</h3></div>',
  ));

  register_sidebar(array(
    'name'          => __('Solutions', 'roots'),
  ...
  register_sidebar(array(
    'name'          => __('The Stakes', 'roots'),
    'id'            => 'sidebar-thestakes',
    'before_widget' => '<section class="page-nav widget %1$s %2$s">',
    'after_widget'  => '</section>',
    'before_title'  => '<div class="title-fx">
        <span class="title-fx-back">Naviga<br>tion</span>
  ...
  register_sidebar(array(
    'name'          => __('Footer Top Three', 'roots'),
...
class Roots_Vcard_Widget extends WP_Widget {
  ...
  function __construct() {
    ...
    $this->WP_Widget('widget_roots_vcard', __('EKWIP: vCard', 'roots'), $widget_ops);
