...
class MCAPI_Legacy {
    ...
    /**
     * Connect to the MailChimp API for a given list. All MCAPI_Legacy calls require login before functioning
     *
     ...
     */
    function MCAPI_Legacy($username_or_apikey, $password=null, $secure=false) {
    ...
    */
     ...
     * @return boolean true on success, false on failure. When using MCAPI_Legacy.class.php, the value can be tested and error messages pulled from the MCAPI_Legacy object (see below)
     */
     ...
     * @return boolean true on success, false on failure. When using MCAPI_Legacy.class.php, the value can be tested and error messages pulled from the MCAPI_Legacy object
     */
    ...
    function callServer($method, $params) {
        ...
        $payload .= "User-Agent: MCAPI_Legacy/" . $this->version ."\r\n";
