...
(function() {
    ...
    tinymce.create('tinymce.plugins.km_grid', {
        createControl: function(n, cm) {
            switch (n) {                
                case 'km_grid':
                var c = cm.createSplitButton('km_grid', {
                    title : '12 columns based grid system',
                    image : '../wp-content/plugins/km-shortcodes/assets/images/grid.png',
                    onclick : function() {
                    }
                });
                ...
                c.onRenderMenu.add(function(c, m) {
                    ...
                    m.add({title : 'Grid builder', onclick : function() {
                         tb_show('Grid builder', '../wp-content/plugins/km-shortcodes/assets/js/plugins/grid.html?TB_iframe=1');
                    }}); 
    ...
    tinymce.PluginManager.add('km_grid', tinymce.plugins.km_grid);
})();
