...
(function() {
    ...
    tinymce.create('tinymce.plugins.km_alerts', {
        createControl: function(n, cm) {
            switch (n) {                
                case 'km_alerts':
                var c = cm.createSplitButton('km_alerts', {
                    title : 'Notification',
                    image : '../wp-content/plugins/km-shortcodes/assets/images/alert.png',
                    onclick : function() {
                    }
                });
    ...
    tinymce.PluginManager.add('km_alerts', tinymce.plugins.km_alerts);
})();
